...
const s = StyleSheet.create({
  ...
  upgradeText: { color: '#000', fontSize: 13, fontWeight: '900' },
  smallBanner: { backgroundColor: '#f59e0b', marginHorizontal: 20, marginVertical: 8, borderRadius: 8, paddingVertical: 10, alignItems: 'center' },
