...
const Q_NUTRITION: Question[] = [
  ...
  { q: "Quel minéral est essentiel pour la formation des os et des dents ?", choices: ['Magnésium', 'Calcium', 'Potassium', 'Zinc'], answer: 1, explanation: "Le calcium (99 % dans les os et dents) est indispensable à la solidité du squelette. Les produits laitiers, les sardines en boîte et le brocoli en sont de bonnes sources." },
  { q: "La vitamine D est synthétisée par notre corps grâce à :", choices: ['La nourriture uniquement', 'L\'exposition au soleil', 'Le sommeil', 'L\'activité physique'], answer: 1, explanation: "La peau produit de la vitamine D3 sous l'action des rayons UVB du soleil. En hiver au Canada, la supplémentation est recommandée car l'angle du soleil est insuffisant pour déclencher la synthèse." },
  { q: "L'indice glycémique (IG) mesure :", choices: ['La quantité de sucre dans un aliment', 'La vitesse à laquelle un aliment élève la glycémie', 'Le nombre de calories d\'un aliment', 'La teneur en fibres'], answer: 1, explanation: "Un IG élevé (>70) provoque un pic de glycémie rapide suivi d'une chute (fringale). Les aliments à IG bas (légumineuses, oléagineux) maintiennent une énergie stable plus longtemps." },
  { q: "Quel fruit tropical contient de la bromélaïne, une enzyme qui aide à digérer les protéines ?", choices: ['Mangue', 'Papaye', 'Ananas', 'Maracuja'], answer: 2, explanation: "L'ananas contient de la bromélaïne, une enzyme protéolytique utilisée comme attendrisseur de viande et en médecine anti-inflammatoire. La papaye contient une enzyme similaire : la papaïne." },
  { q: "Quelle quantité de protéines contient environ 100 g de poitrine de poulet cuit ?", choices: ['15 g', '22 g', '31 g', '40 g'], answer: 2, explanation: "100 g de poitrine de poulet cuit sans peau contient environ 31 g de protéines complètes — toutes les acides aminés essentiels y sont présents. C'est l'une des meilleures sources de protéines maigres." },
  { q: "Le fer héminique, mieux absorbé par le corps, provient de :", choices: ['Les légumineuses', 'Les épinards', 'La viande et le poisson', 'Les céréales enrichies'], answer: 2, explanation: "Le fer héminique (viande rouge, foie, poissons) est absorbé à 15-35 % contre 2-20 % pour le fer non-héminique (végétaux). La vitamine C augmente l'absorption du fer non-héminique." },
  { q: "Quel aliment est surnommé 'superaliment' pour sa richesse en antioxydants, oméga-3 et fibres ?", choices: ['Quinoa', 'Graine de chia', 'Spiruline', 'Chou kale'], answer: 1, explanation: "Les graines de chia contiennent 17 g de fibres/100 g, des oméga-3 végétaux (ALA), du calcium et des antioxydants. Elles absorbent 12 fois leur poids en eau, ce qui prolonge la satiété." },
  { q: "La mélatonine, hormone du sommeil, est produite à partir de quel acide aminé ?", choices: ['Glutamine', 'Tryptophane', 'Tyrosine', 'Lysine'], answer: 1, explanation: "Le tryptophane (présent dans la dinde, les noix, les bananes) est le précurseur de la sérotonine puis de la mélatonine. Consommer des glucides complexes le soir aide à transporter le tryptophane vers le cerveau." },
  { q: "Quel sucre a un indice glycémique plus bas que le sucre blanc ?", choices: ['Cassonade', 'Miel', 'Sirop d\'agave', 'Sucre de coco'], answer: 3, explanation: "Le sucre de coco a un IG d'environ 35 contre 65 pour le sucre blanc, grâce à sa teneur en inuline (fibre). Le sirop d'agave est riche en fructose, ce qui peut surcharger le foie malgré son IG bas." },
  { q: "Un pain est vraiment 'complet' lorsque sa farine est :", choices: ['Enrichie en son uniquement', 'Intégrale (T150) ou semi-complète (T110)', 'Blanche avec colorant brun', 'Sans gluten'], answer: 1, explanation: "La farine T150 (intégrale) contient son, germe et albumen du grain. Méfiez-vous des pains 'multicéréales' qui peuvent être à base de farine blanche colorée. Vérifiez l'étiquette : la farine complète doit être en premier." },
  { q: "Quel légume est particulièrement riche en lutéine, un antioxydant bénéfique pour les yeux ?", choices: ['Carotte', 'Chou kale', 'Betterave', 'Radis'], answer: 1, explanation: "Le chou kale (chou frisé) est extrêmement riche en lutéine et zéaxanthine, qui protègent la rétine de la dégénérescence maculaire liée à l'âge. Les œufs en sont aussi une source importante." },
  { q: "Quel est le rôle principal des fibres alimentaires dans l'organisme ?", choices: ['Fournir de l\'énergie rapide', 'Nourrir le microbiome intestinal et réguler le transit', 'Construire les muscles', 'Absorber les vitamines liposolubles'], answer: 1, explanation: "Les fibres prébiotiques nourrissent les bactéries bénéfiques du microbiome. Les fibres solubles (avoine, légumineuses) forment un gel qui ralentit l'absorption du sucre. Les fibres insolubles régulent le transit intestinal." },
  { q: "La vitamine B12 est essentielle pour :", choices: ['La vue', 'La production de globules rouges et le système nerveux', 'La solidité des os', 'La synthèse de testostérone'], answer: 1, explanation: "La B12 est indispensable à la formation des globules rouges et à la myélinisation des nerfs. Elle est absente des aliments végétaux — les vegans doivent impérativement se supplémenter pour éviter l'anémie et des dommages neurologiques." },
  { q: "Quelle huile végétale a le meilleur équilibre oméga-6/oméga-3 pour la santé ?", choices: ["Huile de tournesol", "Huile de palme", "Huile de colza (canola)", "Huile de maïs"], answer: 2, explanation: "L'huile de colza (canola) a un ratio oméga-6/oméga-3 d'environ 2:1 — proche de l'idéal recommandé (4:1). L'huile de tournesol a un ratio >100:1, très défavorable sur le plan inflammatoire." },
];
...
const Q_NATURE: Question[] = [
  ...
  { q: "Quel est le plus grand désert chaud du monde ?", choices: ['Désert de Gobi', 'Désert d\'Arabie', 'Désert du Sahara', 'Désert de Kalahari'], answer: 2, explanation: "Le Sahara couvre 9,2 millions de km² — soit la superficie des États-Unis. Contrairement à l'image d'Épinal, seulement 25 % de sa superficie est couverte de dunes de sable (erg) ; le reste est rocheux (reg, hamada)." },
  { q: "Quel insecte peut soulever jusqu'à 50 fois son propre poids ?", choices: ['Abeille', 'Fourmi coupe-feuille', 'Fourmi tisserande', 'Scarabée rhinocéros'], answer: 3, explanation: "Le scarabée rhinocéros peut soulever 850 fois son propre poids selon certaines études — le plus fort proportionnellement sur Terre. Les fourmis coupe-feuilles portent 50 fois leur poids, ce qui est déjà exceptionnel." },
  { q: "Quel phénomène est à l'origine de la bioluminescence des lucioles et des méduses ?", choices: ['Une réaction chimique entre luciférine et luciférase', 'Une propriété électrique des cellules', 'L\'absorption de lumière solaire', 'Une réaction avec l\'oxygène de l\'eau'], answer: 0, explanation: "La bioluminescence est une réaction chimique : la luciférine (substrat) est oxydée par la luciférase (enzyme) en présence d'ATP, libérant de la lumière sans chaleur. 76 % des organismes marins profonds sont bioluminescents." },
  { q: "Qu'est-ce qu'une symbiose mycorhizienne ?", choices: ["Une maladie fongique des arbres", "Une association mutuelle entre champignons et racines de plantes", "Un parasite qui tue les champignons", "La décomposition d'arbres morts"], answer: 1, explanation: "Les mycorhizes sont des champignons qui colonisent les racines des plantes : les champignons reçoivent des sucres et transmettent eau et minéraux. 90 % des plantes terrestres en dépendent. Les forêts communiquent via ce 'Wood Wide Web'." },
  { q: "Le baobab africain est surnommé 'arbre bouteille' car il peut stocker :", choices: ['500 litres d\'eau', '5 000 litres d\'eau', 'Jusqu\'à 120 000 litres d\'eau', '1 million de litres d\'eau'], answer: 2, explanation: "Un baobab mature peut contenir jusqu'à 120 000 litres d'eau dans son tronc fibreux et spongieux — essentiel pour survivre aux longues saisons sèches d'Afrique sub-saharienne. Il peut vivre plus de 2 000 ans." },
  { q: "Quel mammifère marin possède le chant le plus complexe et le plus long du règne animal ?", choices: ['Dauphin', 'Orque', 'Baleine à bosse', 'Narval'], answer: 2, explanation: "La baleine à bosse produit des chants pouvant durer 20 minutes et portant sur des centaines de km. Les mâles modifient collectivement leur chant au fil des saisons. On y a détecté des structures culturelles." },
  { q: "Quelle est la profondeur maximale des océans (fosse des Mariannes) ?", choices: ['6 200 m', '8 800 m', '11 034 m', '14 500 m'], answer: 2, explanation: "La fosse des Mariannes (Pacifique) atteint 11 034 m au Challenger Deep — plus profond que le mont Everest est haut (8 849 m). La pression y est 1 100 fois celle en surface. Des organismes y vivent malgré l'obscurité totale." },
  { q: "Quel est le plus grand être vivant sur Terre par masse et superficie ?", choices: ['La baleine bleue', 'La séquoia géante', 'Un réseau de champignons (Armillaria) en Oregon', 'La Grande Barrière de corail'], answer: 2, explanation: "Un champignon Armillaria ostoyae dans l'Oregon s'étend sur 9,6 km² et pèse des milliers de tonnes — estimé à 8 650 ans. Il est considéré le plus grand et plus vieux organisme sur Terre." },
  { q: "Quel phénomène climatique El Niño provoque-t-il principalement ?", choices: ['Des hivers plus froids au Canada', 'Un réchauffement anormal des eaux du Pacifique Est perturbant la météo mondiale', 'Des ouragans plus intenses en Atlantique', 'Une sécheresse permanente en Afrique'], answer: 1, explanation: "El Niño est un réchauffement des eaux du Pacifique central et Est. Il perturbe les courants-jets et provoque : sécheresses en Australie, pluies diluviennes au Pérou, hivers plus doux dans l'ouest canadien, moins de tornades au Texas." },
  { q: "Les albatros peuvent voler combien d'années sans jamais se poser sur terre ferme ?", choices: ['1 an', '3 ans', '5 ans', 'Jusqu\'à 10 ans'], answer: 2, explanation: "Les jeunes albatros peuvent planer 5 ans sur les océans sans se poser, dormant peut-être en vol. Ils couvrent 120 000 km/an. L'albatros hurleur a la plus grande envergure (3,5 m) de tous les oiseaux." },
  { q: "Quel arbre est l'emblème du Canada et figure sur son drapeau ?", choices: ['Épinette blanche', 'Chêne rouge', 'Érable à sucre', 'Bouleau blanc'], answer: 2, explanation: "L'érable à sucre est l'emblème national du Canada depuis 1965. Son sirop (acériculture) est produit à 71 % au Québec. Un érable à sucre mature peut vivre plus de 300 ans et produit ~40 litres de sève pour 1 litre de sirop." },
  { q: "Quel animal canadien est le mammifère semi-aquatique le plus grand d'Amérique du Nord ?", choices: ['Loutre de rivière', 'Rat musqué', 'Castor', 'Vison d\'Amérique'], answer: 2, explanation: "Le castor (Castor canadensis) peut peser jusqu'à 35 kg et est l'animal emblème du Canada. Ses barrages modifient l'hydologie des cours d'eau, créant des zones humides vitales pour des centaines d'espèces." },
  { q: "Combien d'espèces de conifères pousse naturellement au Canada ?", choices: ['12', '25', '35', 'Plus de 50'], answer: 2, explanation: "Le Canada abrite environ 35 espèces de conifères indigènes (épicéas, pins, sapins, thuyas, cèdres). La forêt boréale canadienne est la plus grande forêt intacte du monde, couvrant 552 millions d'hectares." },
  { q: "Quel mécanisme permet aux arbres d'une forêt de partager des nutriments ?", choices: ['Les racines qui fusionnent directement', 'Le réseau mycorhizien souterrain', 'Les feuilles qui se touchent', 'Les phéromones aériennes'], answer: 1, explanation: "Via le réseau mycorhizien, les arbres mères transfèrent des sucres aux jeunes pousses à l'ombre. Peter Wohlleben a popularisé ce concept dans 'La Vie secrète des arbres' (2015). Les épinettes et bouleaux échangent aussi des signaux chimiques d'alarme." },
];
...
const Q_HISTOIRE: Question[] = [
  ...
  { q: "Quel traité a mis fin à la Première Guerre mondiale en 1919 ?", choices: ['Traité de Paris', 'Traité de Versailles', 'Traité de Westphalie', 'Traité de Brest-Litovsk'], answer: 1, explanation: "Le Traité de Versailles (28 juin 1919) a officiellement mis fin à la Première Guerre mondiale. Il imposait à l'Allemagne des réparations énormes (~269 milliards en euros actuels), une perte de territoires et une limitation de son armée — conditions qui ont favorisé la montée du nazisme." },
  { q: "Qui a assassiné Abraham Lincoln en 1865 ?", choices: ['Jefferson Davis', 'John Wilkes Booth', 'Charles Guiteau', 'Leon Czolgosz'], answer: 1, explanation: "John Wilkes Booth, acteur et sympathisant confédéré, a assassiné Lincoln au Ford's Theatre à Washington D.C. le 14 avril 1865 — 5 jours après la fin de la Guerre de Sécession. Lincoln est le premier président américain assassiné." },
  { q: "Quel pharaon a fait construire la Grande Pyramide de Gizeh ?", choices: ['Ramsès II', 'Toutankhamon', 'Khéops (Khoufou)', 'Aménophis IV'], answer: 2, explanation: "La Grande Pyramide a été construite vers 2560 av. J.-C. pour le pharaon Khéops (Khoufou). Elle mesurait 146,6 m à l'origine — la plus haute structure humaine pendant 3 800 ans. Elle est la seule des 7 merveilles du monde antique encore debout." },
  { q: "Quel est le premier pays au monde à avoir accordé le droit de vote aux femmes ?", choices: ['France', 'Canada', 'Nouvelle-Zélande', 'Suède'], answer: 2, explanation: "La Nouvelle-Zélande a été le premier pays à accorder le droit de vote aux femmes en 1893. Le Québec a été la dernière province canadienne à accorder ce droit aux femmes provinciales — seulement en 1940, soit 22 ans après le fédéral (1918)." },
  { q: "Qui était le premier Premier ministre du Canada ?", choices: ['Wilfrid Laurier', 'John A. Macdonald', 'Alexander Mackenzie', 'Robert Borden'], answer: 1, explanation: "Sir John A. Macdonald (1815-1891) est le premier et quatrième Premier ministre du Canada (1867-1873 et 1878-1891). Il est l'architecte de la Confédération et du chemin de fer transcontinental, mais aussi responsable des politiques contre les Premières Nations (pensionnats)." },
  { q: "La Charte canadienne des droits et libertés a été adoptée en quelle année ?", choices: ['1967', '1975', '1982', '1988'], answer: 2, explanation: "La Charte canadienne fait partie de la Loi constitutionnelle de 1982, signée par Pierre Elliott Trudeau — contre la volonté du Québec, qui ne l'a jamais ratifiée formellement. La Cour suprême peut invalider des lois qui contreviennent à la Charte." },
  { q: "Louis Riel a mené quelle rébellion historique au Canada ?", choices: ['Rébellion des Patriotes (1837)', 'Rébellion de la rivière Rouge (1869) et du Nord-Ouest (1885)', 'Guerre boer canadienne', 'Révolte de la Couronne'], answer: 1, explanation: "Louis Riel a défendu les droits des Métis lors de la résistance de la Rivière-Rouge (Manitoba, 1869) et la rébellion du Nord-Ouest (Saskatchewan, 1885). Il a été pendu en 1885 — un martyr pour les Francophones et les Métis, une trahison pour d'autres." },
  { q: "En quelle année Montréal a-t-elle accueilli les Jeux olympiques d'été ?", choices: ['1968', '1972', '1976', '1980'], answer: 2, explanation: "Montréal a accueilli les Jeux olympiques d'été en 1976 (XXIe olympiade) — seule ville canadienne à l'avoir fait. La dette du Stade olympique n'a été entièrement remboursée qu'en 2006, soit 30 ans après les Jeux." },
  { q: "Quel empire est généralement considéré le plus grand de l'histoire par superficie ?", choices: ['Empire romain', 'Empire mongol', 'Empire britannique', 'Empire ottoman'], answer: 2, explanation: "L'Empire britannique a atteint 35,5 millions de km² à son apogée (1920) — 26 % des terres émergées. L'Empire mongol (24 millions de km²) a été le plus grand empire terrestre contigu. 'Le soleil ne se couche jamais sur l'Empire britannique' était littéralement vrai." },
  { q: "Quel explorateur est arrivé aux Amériques en 1492 ?", choices: ['Amerigo Vespucci', 'John Cabot', 'Christophe Colomb', 'Fernando de Magellan'], answer: 2, explanation: "Christophe Colomb débarque aux Bahamas le 12 octobre 1492 sous la bannière espagnole. Il n'a jamais atteint le continent américain et cru jusqu'à sa mort être arrivé en Asie. Amerigo Vespucci a réalisé le premier que c'était un nouveau continent — d'où 'Amérique'." },
  { q: "Quel événement marquant s'est produit le 11 novembre 1918 à 11h ?", choices: ['Début de la Première Guerre mondiale', 'Signature de l\'armistice mettant fin à la Grande Guerre', 'Traité de Versailles', 'Chute du mur de Berlin'], answer: 1, explanation: "L'armistice du 11 novembre 1918 à 11h00 met fin aux combats de la Première Guerre mondiale. 18 millions de personnes sont mortes (dont 67 000 Canadiens). Le 11 novembre est le Jour du Souvenir au Canada." },
  { q: "Qui était Napoléon Bonaparte et d'où venait-il originellement ?", choices: ['Un général français né à Paris', 'Un noble corse devenu Empereur des Français', 'Un prince autrichien conquérant', 'Un général suisse au service de la France'], answer: 1, explanation: "Napoléon Bonaparte (1769-1821) est né en Corse, île française depuis 1768. Il s'est élevé de général républicain à Consul puis Empereur (1804). Il a codifié le droit français (Code Napoléon) encore utilisé au Québec." },
  { q: "La Révolution tranquille au Québec s'est produite principalement dans quelle décennie ?", choices: ['1940', '1950', '1960', '1970'], answer: 2, explanation: "La Révolution tranquille (années 1960) a transformé le Québec sous Jean Lesage : nationalisation de l'électricité (Hydro-Québec), laïcisation de l'éducation et de la santé, émergence d'une identité québécoise moderne distincte du clergé catholique." },
  { q: "Quel pays a lancé le premier satellite artificiel de l'histoire (Spoutnik) ?", choices: ['États-Unis', 'Chine', 'URSS (Union soviétique)', 'France'], answer: 2, explanation: "L'URSS a lancé Spoutnik 1 le 4 octobre 1957 — provoquant un choc aux États-Unis ('choc Spoutnik') et lançant la course à l'espace. Cet événement a accéléré la création de la NASA en 1958." },
  { q: "Les femmes québécoises ont obtenu le droit de vote provincial en quelle année ?", choices: ['1918', '1929', '1940', '1960'], answer: 2, explanation: "Les femmes québécoises ont obtenu le droit de vote provincial le 25 avril 1940 — sous Adélard Godbout, après des années de lutte menée par Thérèse Casgrain. Le Québec était la dernière province canadienne à accorder ce droit aux femmes." },
];
...
const Q_LIEUX: Question[] = [
  ...
  { q: "Quelle est la capitale du Yukon ?", choices: ['Dawson City', 'Whitehorse', 'Watson Lake', 'Haines Junction'], answer: 1, explanation: "Whitehorse est la capitale et la plus grande ville du Yukon (~27 000 habitants). Elle est traversée par le fleuve Yukon et était une étape clé lors de la Ruée vers l'or du Klondike (1898). Dawson City était la capitale originale." },
  { q: "La tour CN de Toronto, anciennement la plus haute tour du monde, mesure :", choices: ['329 m', '447 m', '553 m', '632 m'], answer: 2, explanation: "La tour CN mesure 553,33 m — la plus haute tour autoportante au monde de 1976 à 2007 (dépassée par la tour Canton et le Burj Khalifa). Elle peut résister à des vents de 260 km/h et à un séisme de magnitude 8,5." },
  { q: "Le mont Logan, point culminant du Canada, se trouve dans quelle province/territoire ?", choices: ['Colombie-Britannique', 'Alberta', 'Yukon', 'Territoires du Nord-Ouest'], answer: 2, explanation: "Le mont Logan (5 959 m) est le point culminant du Canada et le 2e plus haut sommet d'Amérique du Nord après le Denali (6 190 m). Il se trouve dans le Parc national Kluane au Yukon — inscrit au patrimoine mondial de l'UNESCO." },
  { q: "Quelle ville canadienne est divisée en Haute-Ville et Basse-Ville par une falaise ?", choices: ['Montréal', 'Québec', 'Saint-Jean-de-Terre-Neuve', 'Victoria'], answer: 1, explanation: "Québec est unique avec sa Haute-Ville (sur le Cap-Diamant, ~98 m) et sa Basse-Ville (au bord du fleuve). Le Funiculaire (1879) les relie. Québec est la seule ville fortifiée au nord du Mexique en Amérique du Nord." },
  { q: "L'île de Vancouver appartient à quelle province canadienne ?", choices: ['Alberta', 'Colombie-Britannique', 'Yukon', 'Saskatchewan'], answer: 1, explanation: "L'île de Vancouver est la plus grande île du Pacifique Est canadien (~457 000 habitants). Victoria, la capitale de la C.-B., s'y trouve. Elle est séparée du continent par le détroit de Géorgie et le détroit de Juan de Fuca." },
  { q: "Le territoire du Nunavut a été créé en quelle année ?", choices: ['1982', '1993', '1999', '2005'], answer: 2, explanation: "Le Nunavut est devenu le 3e territoire canadien le 1er avril 1999, après avoir été séparé des Territoires du Nord-Ouest. Il est le plus grand territoire du Canada (2 millions de km²) et est majoritairement peuplé d'Inuit (~36 000 habitants)." },
  { q: "Quel pays compte le plus grand nombre de lacs d'eau douce au monde ?", choices: ['Russie', 'Brésil', 'Canada', 'États-Unis'], answer: 2, explanation: "Le Canada possède 563 lakes de plus de 100 km² et contient environ 60 % des lacs d'eau douce de la planète. Les Grands Lacs (partagés avec les États-Unis) contiennent 21 % des réserves d'eau douce de surface mondiale." },
  { q: "La ville de Banff se trouve dans quel parc national d'Alberta ?", choices: ['Parc national Jasper', 'Parc national Banff', 'Parc national Kootenay', 'Parc national Yoho'], answer: 1, explanation: "La ville de Banff est la seule ville dans un parc national canadien (Parc national Banff, fondé 1885). Le lac Louise et les sources thermales Hot Springs y sont célèbres. La route des Glaciers relie Banff à Jasper sur 230 km." },
  { q: "La Route 66 américaine relie Chicago à quelle ville californienne ?", choices: ['Los Angeles', 'San Francisco', 'San Diego', 'Santa Barbara'], answer: 0, explanation: "La Route 66 (inaugurée 1926) relie Chicago à Santa Monica, Los Angeles, sur 3 940 km. Surnommée 'Main Street of America', elle a été déclassifiée en 1985 mais reste un mythe de la liberté américaine." },
  { q: "Quelle ville mondiale est surnommée 'La Ville des Ponts' avec plus de 400 ponts ?", choices: ['Amsterdam', 'Venise', 'Hambourg', 'Stockholm'], answer: 2, explanation: "Hambourg (Allemagne) possède plus de 2 500 ponts — plus que Venise, Amsterdam et Londres réunis. Cette particularité est due aux nombreux canaux, tributaires de l'Elbe qui traversent la ville portuaire." },
  { q: "Le parc national de Wood Buffalo, le plus grand du Canada, se trouve dans :", choices: ['Manitoba et Saskatchewan', 'Alberta et Territoires du Nord-Ouest', 'Colombie-Britannique', 'Yukon et Alaska'], answer: 1, explanation: "Le Parc national Wood Buffalo (44 807 km²) chevauche l'Alberta et les T.N.-O. C'est le plus grand parc national du Canada et l'un des plus grands au monde — plus grand que la Suisse. Il abrite le plus grand troupeau de bisons sauvages au monde." },
  { q: "Quelle est la province canadienne la moins peuplée ?", choices: ['Île-du-Prince-Édouard', 'Nouveau-Brunswick', 'Terre-Neuve-et-Labrador', 'Manitoba'], answer: 0, explanation: "L'Île-du-Prince-Édouard (~170 000 habitants) est la province la moins peuplée et la plus petite du Canada. C'est aussi 'le berceau de la Confédération' — c'est à Charlottetown qu'ont eu lieu les conférences de 1864 menant à la Confédération de 1867." },
  { q: "Quel détroit sépare l'Île-du-Prince-Édouard du Nouveau-Brunswick ?", choices: ['Détroit de Cabot', 'Détroit de Northumberland', 'Détroit de Juan de Fuca', 'Détroit de Belle Isle'], answer: 1, explanation: "Le détroit de Northumberland sépare l'Î.-P.-É. du Nouveau-Brunswick et de la Nouvelle-Écosse. Le pont de la Confédération (1997, 12,9 km) traverse ce détroit — le plus long pont au-dessus d'eaux glacées au monde." },
  { q: "Dans quelle ville se trouve le Musée canadien des droits de la personne ?", choices: ['Ottawa', 'Toronto', 'Winnipeg', 'Vancouver'], answer: 2, explanation: "Le Musée canadien des droits de la personne est situé à Winnipeg, Manitoba — la seule capitale muséale nationale hors Ottawa. Inauguré en 2014, c'est le seul musée national au Canada dédié uniquement aux droits de la personne." },
];
...
const Q_SPORT: Question[] = [
  ...
  { q: "Quelle équipe de basketball a remporté le plus de titres NBA ?", choices: ['Los Angeles Lakers', 'Chicago Bulls', 'Boston Celtics', 'Golden State Warriors'], answer: 2, explanation: "Les Boston Celtics détiennent le record de 18 titres NBA (dont 17 pour Bill Russell). Les Lakers en comptent 17. Les Raptors de Toronto sont la seule équipe canadienne à avoir remporté le titre (2019)." },
  { q: "Quel pays a remporté la Coupe du Monde de football 2022 au Qatar ?", choices: ['Brésil', 'France', 'Angleterre', 'Argentine'], answer: 3, explanation: "L'Argentine a remporté la Coupe du Monde 2022 en battant la France aux tirs au but (3-3 après prolongations, 4-2 aux tirs au but). Lionel Messi a remporté son premier Mondial, complétant sa carrière légendaire." },
  { q: "Quel athlète détient le record du monde du 100m masculin ?", choices: ['Usain Bolt', 'Tyson Gay', 'Yohan Blake', 'Justin Gatlin'], answer: 0, explanation: "Usain Bolt (Jamaïque) a couru le 100m en 9,58 secondes aux Mondiaux de Berlin en 2009 — record du monde toujours en vigueur. Il a aussi le record du 200m (19,19s). Il a remporté 8 médailles d'or olympiques." },
  { q: "Tiger Woods a remporté combien de tournois du Grand Chelem en golf (Majors) ?", choices: ['9', '12', '15', '18'], answer: 2, explanation: "Tiger Woods a remporté 15 Majors en golf : 5 Masters, 4 US Opens, 3 Open Championship, 3 PGA Championships. Il a égalé les 18 titres de Jack Nicklaus avant ses blessures. Son retour gagnant au Masters 2019 est considéré parmi les plus grands comebacks sportifs." },
  { q: "Quelle équipe de hockey a remporté la Coupe Stanley en 2024 ?", choices: ['Vegas Golden Knights', 'Florida Panthers', 'Colorado Avalanche', 'Edmonton Oilers'], answer: 1, explanation: "Les Florida Panthers ont remporté leur première Coupe Stanley en 2024 en battant les Oilers d'Edmonton en 7 matchs. C'est leur deuxième finale consécutive après leur défaite de 2023 contre Vegas." },
  { q: "Quel nageur détient le plus grand nombre de médailles olympiques de toute l'histoire ?", choices: ['Ian Thorpe', 'Mark Spitz', 'Michael Phelps', 'Ryan Lochte'], answer: 2, explanation: "Michael Phelps (États-Unis) détient 28 médailles olympiques (23 or, 3 argent, 2 bronze) — le plus grand médaillé olympique de tous les temps. Aux JO de 2008 à Pékin, il a remporté 8 médailles d'or en un seul Jeux." },
  { q: "Le tournoi de Wimbledon se joue sur quelle surface ?", choices: ['Terre battue', 'Gazon naturel', 'Surface dure (hard court)', 'Moquette synthétique'], answer: 1, explanation: "Wimbledon (fondé 1877) est le seul Grand Chelem encore joué sur gazon naturel. La vitesse de rebond est ~140 km/h contre ~80 km/h sur terre battue. Les joueurs doivent obligatoirement porter du blanc sur les courts." },
  { q: "Quel joueur de football (soccer) détient le record du plus grand nombre de buts en Ligue des Champions ?", choices: ['Messi', 'Ronaldo', 'Raúl', 'Benzema'], answer: 1, explanation: "Cristiano Ronaldo détient le record de 140 buts en Ligue des Champions UEFA — plus que tout autre joueur. Il a remporté 5 titres de la LdC avec le Real Madrid et 1 avec Manchester United. Messi en compte 129." },
  { q: "Quel pays a remporté le plus de médailles d'or en sports d'hiver dans l'histoire olympique ?", choices: ['Russie/URSS', 'Norvège', 'Allemagne', 'États-Unis'], answer: 1, explanation: "La Norvège est la nation la plus titrée aux JO d'hiver avec 148 médailles d'or (au cumul jusqu'en 2022). Aux JO d'Oslo 1952, la Norvège a remporté 16 médailles sur 22 au ski de fond. Le ski fait partie de la culture norvégienne depuis 5 000 ans." },
  { q: "Alexandre Bilodeau a été le premier Canadien à remporter l'or olympique sur sol canadien. Dans quelle discipline ?", choices: ['Ski alpin', 'Ski acrobatique (bosses)', 'Patinage de vitesse', 'Biathlon'], answer: 1, explanation: "Alexandre Bilodeau a remporté l'or en ski de bosses aux JO de Vancouver 2010 (13 février) — le premier or canadien sur sol canadien en 88 ans de Jeux olympiques. Il a répété l'exploit à Sotchi 2014." },
  { q: "Quel club de baseball a remporté les Séries mondiales en 1992 et 1993 ?", choices: ['New York Yankees', 'Toronto Blue Jays', 'Los Angeles Dodgers', 'Cincinnati Reds'], answer: 1, explanation: "Les Toronto Blue Jays ont remporté les Séries mondiales en 1992 (contre les Braves d'Atlanta) et 1993 (contre les Phillies). Ils sont la seule équipe canadienne à avoir remporté la Série mondiale — et ce deux fois consécutives." },
  { q: "Qui est le joueur ayant marqué le plus de points dans l'histoire de la NBA ?", choices: ['Kareem Abdul-Jabbar', 'LeBron James', 'Michael Jordan', 'Kobe Bryant'], answer: 1, explanation: "LeBron James a dépassé Kareem Abdul-Jabbar en 2023 pour devenir le meilleur marqueur de l'histoire NBA avec plus de 38 000 points. LeBron a joué pour Cleveland, Miami, Los Angeles et est le seul à avoir eu des franchises de NBA à son nom." },
  { q: "En quelle année le Québec a-t-il accueilli les premiers Jeux de la Francophonie ?", choices: ['1987', '1997', '2001', '2006'], answer: 0, explanation: "Les premiers Jeux de la Francophonie se sont tenus au Maroc en 1987, mais le Québec a accueilli les IVes Jeux en 2001 (Ottawa-Hull). Le Canada a accueilli les Jeux à Moncton en 2021 (reportés à 2022 pour la COVID)." },
  { q: "Quel sport combine du ski de fond et du tir à la carabine ?", choices: ['Ski alpinisme', 'Combiné nordique', 'Biathlon', 'Skiathlon'], answer: 2, explanation: "Le biathlon combine ski de fond et tir à la carabine (.22 LR). Le rythme cardiaque élevé après le ski rend le tir très difficile. Les athlètes doivent descendre en dessous de 160 bpm. La Norvège et l'Allemagne dominent ce sport aux JO d'hiver." },
];
...
const Q_ARTISTE: Question[] = [
  ...
  { q: "Quel chanteur québécois est connu pour 'Les années 80', 'Blanc cassé' et 'Tu m'aimes-tu' ?", choices: ["Daniel Lavoie", "Richard Séguin", "Richard Desjardins", "Paul Piché"], answer: 2, explanation: "Richard Desjardins est un chanteur-poète abitibien, auteur-compositeur de 'Tu m'aimes-tu' (1990) et réalisateur du documentaire environnemental 'L'Erreur boréale' (1999). Il est l'une des voix les plus respectées de la chanson québécoise." },
  { q: "Taylor Swift est originaire de quel état américain ?", choices: ['Tennessee', 'Pennsylvanie', 'Texas', 'Géorgie'], answer: 1, explanation: "Taylor Swift est née à Reading, Pennsylvanie (1989), mais a grandi à Hendersonville, Tennessee, où elle a commencé sa carrière à Nashville à 14 ans. Ses albums 'Fearless', 'Red' et '1989' ont défini la pop des années 2010." },
  { q: "Quel groupe de rock québécois est connu pour 'Dégénération' et 'Complainte pour Ste-Catherine' ?", choices: ['Cowboys Fringants', 'Mes Aïeux', 'Les Colocs', 'Loco Locass'], answer: 1, explanation: "Mes Aïeux est un groupe folk-rock québécois fondé en 1996 à Montréal. 'Dégénération' (2004) est devenue un hymne intergénérationnel sur la mémoire collective québécoise. Le groupe mêle instruments traditionnels (violon, violoncelle) et rock." },
  { q: "Quel chanteur français est connu pour 'Ne me quitte pas', monument de la chanson francophone ?", choices: ['Léo Ferré', 'Jacques Brel', 'Charles Aznavour', 'Georges Brassens'], answer: 1, explanation: "Jacques Brel (Belge, 1929-1978) a écrit 'Ne me quitte pas' en 1959 après une rupture. La chanson a été reprise des centaines de fois dans le monde (Nina Simone, Dusty Springfield). Brel est considéré le plus grand poète de la chanson francophone avec Félix Leclerc." },
  { q: "La chanson 'Bohemian Rhapsody' est de quel groupe rock britannique ?", choices: ['The Rolling Stones', 'Led Zeppelin', 'Queen', 'Pink Floyd'], answer: 2, explanation: "Queen a sorti 'Bohemian Rhapsody' en 1975 — composée par Freddie Mercury. La chanson mêle ballade, opéra et rock hard et dure 5h55, très longue pour l'époque. Elle est revenue au sommet des charts après le film biographique (2018)." },
  { q: "Quel groupe suédois a dominé les charts mondiaux avec 'Dancing Queen', 'Fernando' et 'Waterloo' ?", choices: ['Roxette', 'ABBA', 'Ace of Base', 'Europe'], answer: 1, explanation: "ABBA (Agnetha, Björn, Benny, Anni-Frid) a été le groupe pop le plus vendu des années 70-80 avec 400 millions d'albums vendus. Leur revival en 2021 avec l'album 'Voyage' et leur concert holographique 'ABBA Arena' montre leur influence intacte." },
  { q: "Quel chanteur se cache derrière le nom de scène 'The Weeknd' ?", choices: ['Abel Tesfaye', 'Drake (Aubrey Graham)', 'Nav Bhatia', 'Roy Woods'], answer: 0, explanation: "The Weeknd est le pseudonyme d'Abel Makkonen Tesfaye, né en 1990 à Toronto d'immigrants éthiopiens. Ses albums 'After Hours' et 'Dawn FM' ont révolutionné le R&B contemporain. 'Blinding Lights' est l'une des chansons les plus écoutées de l'histoire de Spotify." },
  { q: "Quel groupe canadien est connu pour 'Summer of '69', 'Run to You' et 'Cuts Like a Knife' ?", choices: ['Nickelback', 'Bryan Adams', 'Rush', 'Barenaked Ladies'], answer: 1, explanation: "Bryan Adams est un rockeur de Vancouver connu pour 'Summer of '69' (1985) et la chanson-hommage 'Have You Ever Really Loved a Woman' (1995). Il est l'un des artistes canadiens les plus vendus à l'international avec plus de 75 millions d'albums." },
  { q: "Quel rappeur canadien est connu pour 'God's Plan', 'Hotline Bling' et 'One Dance' ?", choices: ["The Weeknd", "Drake", "Tory Lanez", "Jazz Cartier"], answer: 1, explanation: "Drake (Aubrey Drake Graham) est né à Toronto en 1986. Il a commencé comme acteur dans 'Degrassi'. Son label OVO Sound et ses collaborations ont défini le rap/R&B des années 2010. Il a remporté 4 Grammy Awards et vendu plus de 170 millions de singles." },
  { q: "Quel artiste français est surnommé 'Le Grand Chanteur' et a écrit 'La Bohème' et 'Hier encore' ?", choices: ['Michel Sardou', 'Charles Aznavour', 'Claude François', 'Michel Polnareff'], answer: 1, explanation: "Charles Aznavour (1924-2018), d'origine arménienne, est l'un des chanteurs français les plus connus au monde. 'La Bohème' (1965) et 'She' ont été adaptées en de nombreuses langues. Il a vendu plus de 180 millions de disques en 60 ans de carrière." },
  { q: "Quel groupe de Montréal a connu un succès international avec 'Ordinary World' et 'The Logical Song' ?", choices: ['Simple Plan', 'Supertramp', 'The Arcade Fire', 'Duran Duran'], answer: 1, explanation: "'Ordinary World' (1992) et 'The Logical Song' (1979) sont de Supertramp — groupe britannique, pas montréalais. Arcade Fire de Montréal est connu pour 'Wake Up' et 'The Suburbs' (Album de l'année Grammy 2011)." },
  { q: "Quel chanteur est connu pour 'Let It Be', 'Yesterday' et fait partie des Beatles ?", choices: ['John Lennon', 'George Harrison', 'Ringo Starr', 'Paul McCartney'], answer: 3, explanation: "Paul McCartney a écrit 'Yesterday' et co-écrit 'Let It Be'. Les Beatles (Liverpool, 1960-1970) ont vendu plus de 600 millions d'albums — le groupe le plus vendu de l'histoire. Leur influence est incalculable sur la musique pop mondiale." },
  { q: "Quel artiste est surnommé 'Le roi de la pop' et a sorti 'Thriller', l'album le plus vendu de tous les temps ?", choices: ['Prince', 'Michael Jackson', 'David Bowie', 'Elton John'], answer: 1, explanation: "Michael Jackson (1958-2009) a vendu plus de 66 millions de copies de 'Thriller' (1982) — l'album le plus vendu de l'histoire. Ses moonwalks, ses clips vidéo révolutionnaires et ses concerts géants ont redéfini le spectacle musical." },
  { q: "Quel groupe de rock alternatif québécois chante en anglais et est connu mondialement pour 'Neighborhood #1 (Tunnels)' ?", choices: ['Men Without Hats', 'Arcade Fire', 'Simple Plan', 'The Tea Party'], answer: 1, explanation: "Arcade Fire (Montréal) a sorti 'Funeral' en 2004 — salué comme l'album de la décennie par de nombreux médias. 'The Suburbs' a remporté l'Album de l'année aux Grammy 2011, battant Eminem et Katy Perry — une des plus grandes surprises de l'histoire du gala." },
];
...
const Q_ACTEUR: Question[] = [
  ...
  { q: "Qui joue Tony Stark / Iron Man dans les films du MCU (Marvel Cinematic Universe) ?", choices: ["Chris Evans", "Robert Downey Jr.", "Mark Ruffalo", "Jeremy Renner"], answer: 1, explanation: "Robert Downey Jr. incarne Tony Stark dans 11 films du MCU (2008-2019). Son personnage est le fondateur des Avengers. Sa mort dans 'Avengers: Endgame' (2019) est l'une des scènes les plus vues de l'histoire du cinéma de super-héros." },
  { q: "Quel acteur australien joue Wolverine / Logan dans la saga X-Men depuis 2000 ?", choices: ["Hugh Jackman", "Russell Crowe", "Eric Bana", "Sam Worthington"], answer: 0, explanation: "Hugh Jackman joue Wolverine dans 17 films (2000-2024) — le record du monde Guinness pour le rôle de super-héros le plus longtemps tenu par un seul acteur. Il a repris le rôle dans 'Deadpool & Wolverine' (2024) après avoir annoncé sa retraite en 2017." },
  { q: "Quelle actrice québécoise est connue pour son rôle dans 'Incendies' de Denis Villeneuve et est lauréate de prix internationaux ?", choices: ["Karine Vanasse", "Sophie Desmarais", "Lubna Azabal", "Guylaine Tremblay"], answer: 2, explanation: "Lubna Azabal (Belge-Marocaine) joue Nawal dans 'Incendies' (2010) de Denis Villeneuve — nommée aux Oscars 2011. Denis Villeneuve (Québec) est aussi connu pour 'Arrival', 'Blade Runner 2049' et la saga 'Dune'." },
  { q: "Quel acteur joue James Bond le plus grand nombre de fois (6 films officiels) ?", choices: ["Sean Connery", "Roger Moore", "Daniel Craig", "Pierce Brosnan"], answer: 1, explanation: "Roger Moore a joué James Bond dans 7 films officiels (1973-1985) — le plus grand nombre. Sean Connery en compte 6 (+ 1 non officiel). Daniel Craig a redéfini Bond avec 5 films plus sombres (2006-2021)." },
  { q: "Qui joue Daenerys Targaryen, la 'Mère des dragons', dans la série 'Game of Thrones' ?", choices: ["Natalie Dormer", "Emilia Clarke", "Sophie Turner", "Maisie Williams"], answer: 1, explanation: "Emilia Clarke joue Daenerys dans toutes les 8 saisons de Game of Thrones (HBO, 2011-2019). Elle a survécu à deux anévrismes cérébraux pendant le tournage de la série. Son arc narratif est l'un des plus controversés de la télévision moderne." },
  { q: "Quel acteur canadien a joué dans 'The Revenant' (2015) et a finalement remporté l'Oscar du meilleur acteur ?", choices: ["Ryan Reynolds", "Ryan Gosling", "Leonardo DiCaprio", "Jim Carrey"], answer: 2, explanation: "Leonardo DiCaprio (américain, non canadien) a remporté son premier Oscar pour 'The Revenant' de Alejandro González Iñárritu — après 5 nominations. Il s'est notamment allongé dans des entrailles d'animaux morts pour le rôle." },
  { q: "Dans quel film Tom Hanks joue-t-il un homme coincé dans un aéroport international ?", choices: ["Cast Away", "Forrest Gump", "The Terminal", "Philadelphia"], answer: 2, explanation: "'The Terminal' (2004) de Steven Spielberg s'inspire de Mehran Karimi Nasseri, un Iranien qui a vécu 18 ans à l'aéroport Charles-de-Gaulle de Paris. Tom Hanks joue Viktor Navorski, coincé dans un aéroport américain après un coup d'État dans son pays." },
  { q: "Quel acteur joue le personnage de Thanos dans 'Avengers: Infinity War' (2018) ?", choices: ["Josh Brolin", "Jason Momoa", "Dave Bautista", "Ron Perlman"], answer: 0, explanation: "Josh Brolin prête ses traits (via capture de performance) à Thanos dans le MCU. Thanos veut éliminer la moitié de toute vie dans l'univers pour 'équilibrer les ressources'. Sa popularité a surpris Marvel — il est devenu l'un des méchants les plus aimés du cinéma." },
  { q: "Qui joue le rôle de Black Panther / T'Challa dans le film Marvel (2018) ?", choices: ["Idris Elba", "Michael B. Jordan", "Chadwick Boseman", "Lupita Nyong'o"], answer: 2, explanation: "Chadwick Boseman (1976-2020) joue T'Challa dans 'Black Panther' (2018) — premier film de super-héros noir en tête des charts mondiaux avec 1,35 milliard $ de recettes. Boseman a tourné le film pendant son traitement contre le cancer du côlon, décédé en août 2020." },
  { q: "Quelle actrice joue Katniss Everdeen dans la saga 'Hunger Games' ?", choices: ["Shailene Woodley", "Emma Stone", "Jennifer Lawrence", "Saoirse Ronan"], answer: 2, explanation: "Jennifer Lawrence joue Katniss dans les 4 films Hunger Games (2012-2015). Elle a remporté l'Oscar du meilleur actrice pour 'Silver Linings Playbook' (2012) à 22 ans — la 2e plus jeune lauréate. Elle a refusé de s'imposer un régime pour jouer Katniss." },
  { q: "Quel réalisateur québécois a signé le film culte 'C.R.A.Z.Y.' en 2005 ?", choices: ["Denis Villeneuve", "Jean-Marc Vallée", "Xavier Dolan", "Philippe Falardeau"], answer: 1, explanation: "Jean-Marc Vallée a réalisé 'C.R.A.Z.Y.' (2005) — le film québécois le plus vu des années 2000. Il a ensuite réalisé 'Dallas Buyers Club' (2013, 2 Oscars), 'Wild' (2014) et les séries 'Big Little Lies' et 'Sharp Objects'. Il est décédé en 2021." },
  { q: "Quel acteur joue le Joker dans 'Joker' (2019) et a remporté l'Oscar pour ce rôle ?", choices: ["Heath Ledger", "Jared Leto", "Joaquin Phoenix", "Jack Nicholson"], answer: 2, explanation: "Joaquin Phoenix remporte l'Oscar du meilleur acteur pour 'Joker' (Todd Phillips, 2019). Heath Ledger a remporté l'Oscar à titre posthume pour le Joker dans 'The Dark Knight' (2008). Phoenix est végétalien et militant des droits des animaux connu pour ses discours aux cérémonies." },
  { q: "Dans 'The Matrix' (1999), quel acteur joue Neo, l'élu ?", choices: ["Will Smith", "Keanu Reeves", "Brad Pitt", "Tom Cruise"], answer: 1, explanation: "Keanu Reeves joue Neo dans la trilogie Matrix (1999-2003) et 'Matrix Resurrections' (2021). Le rôle a été offert à Will Smith qui l'a refusé pour tourner 'Wild Wild West'. Keanu Reeves est Canadien — né à Beyrouth de père hawaïen et mère anglaise, élevé à Toronto." },
  { q: "Quel acteur et humoriste québécois est connu pour 'Bon Cop Bad Cop' et la série 'Trauma' ?", choices: ["Patrick Huard", "Louis-José Houde", "Martin Matte", "François Morency"], answer: 0, explanation: "Patrick Huard joue l'inspecteur David Bouchard dans 'Bon Cop Bad Cop' (2006) — le film québécois le plus rentable de tous les temps (10 M$). Il est aussi auteur, humoriste et réalisateur. La suite 'Bon Cop Bad Cop 2' (2017) a également cartonné." },
];
