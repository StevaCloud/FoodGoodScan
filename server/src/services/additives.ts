export interface AdditiveInfo {
  code: string;
  name: string;
  risk: 'faible' | 'modere' | 'eleve' | 'critique';
  category: string;
  effects: string[];
  description: string;
}

const ADDITIVES_DB: Record<string, AdditiveInfo> = {
...
export function getAdditiveRiskColor(risk: string): string {
  switch (risk) {
...
export function analyzeAdditives(additiveCodes: string[]): AdditiveInfo[] {
